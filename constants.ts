...
import { Student, Report, UserRole, Instructor } from './types';
...
export const MOCK_STUDENTS: Student[] = [
  { id: 's1', name: '田中 太郎', grade: '中学2年生', instructorIds: ['i1'], loginId: 'tanaka_t', password: 'pass888' },
  { id: 's2', name: '佐藤 結衣', grade: '小学6年生', instructorIds: ['i2'], loginId: 'sato_y', password: 'pass777' },
  { id: 's3', name: '鈴木 海斗', grade: '高校1年生', instructorIds: ['i1', 'i3'], loginId: 'suzuki_k', password: 'pass999', targetFaculty: '工学・情報系' },
];
